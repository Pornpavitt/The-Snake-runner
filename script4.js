window.addEventListener('load', function () {
    ...
    function displayLevel(context) {
        ...
        context.fillStyle = 'black';
        context.fillText('Level 4', canvas.width / 2, canvas.height / 2); // Center the text horizontally and vertically
        context.fillStyle = 'white';
        context.fillText('Level 4', canvas.width / 2 + 2, canvas.height / 2 + 2);
    }
